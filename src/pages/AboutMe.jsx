    ...
    <div className="min-h-screen px-4 py-12 bg-background text-foreground sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="mt-2 text-xl text-muted-foreground">Front-end Developer</p>
        </div>
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground">
              Hello! I'm a passionate front-end developer with a love for creating efficient, scalable, and user-friendly web applications. With 2 years of experience in creating web apps as a hobby, I've worked on a variety of projects ranging from small prototypes to full-blown full stack web apps for learning purposes
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge className="hover:bg-[#23272f] dark:hover:text-muted-foreground">React</Badge>
              ...
              <Badge className="hover:bg-[#0f172a] dark:hover:text-muted-foreground">TailwindCSS</Badge>
              <Badge className="hover:bg-[#9a60fe] hover:text-yellow-500">ViteJS</Badge>
              <Badge className="hover:bg-[#c7bfb1] dark:hover:text-black hover:text-muted-foreground">BunJS</Badge>
              ...
              <Badge className="hover:bg-[#090a15] dark:hover:text-muted-foreground">Prisma</Badge>
              <Badge className="hover:bg-[#0d1117] dark:hover:text-muted-foreground">Git</Badge>
            </div>
          </CardContent>
        </Card>
